...
public class CRC {
 ...
 // declare n for the size of the data 
            ...
            // take the size of the data from the userSystem.out.println("Enter the size of the data array: "); 
             size = scan.nextInt(); 
 ...
 // declare rem[] arrem.length0
        int rem[] = new int[divisor.length];
        System.arraycopy(oldData, 0, data, 0, oldData.length);
        System.arraycopy(oldData, 0, rem, 0, divisor.length);
 ...
 // of division 
            rem[divisor.length-1] = sentdata[i+divisor.length]; 
